<?php
// 1. Auth primero — aquí se define soloAdmin()
...
if (isset($_GET['eliminar'])) {
  ...
  if ($total > 0) {
    header("Location: /admin/especialidades/lista_especialidades.php?msg_error=No+se+puede+eliminar:+hay+{$total}+médico(s)+asociado(s).");
    exit;
  }
  ...
  header("Location: /admin/especialidades/lista_especialidades.php?msg=Especialidad+eliminada+correctamente.");
  exit;
}
...
<div class="card mx-auto" style="max-width: 950px;">
  <div style="padding: 30px;">
              ...
              <td style="text-align:center;">
                ...
                <?php else: ?>
                  <a class="btn btn-sm btn-danger"
                    href="/admin/especialidades/lista_especialidades.php?eliminar=<?= $row['id_especialidad'] ?>"
                    title="Eliminar"
    ...
    <div class="d-flex justify-content-end mt-4">
      <a href="../especialidades/registrar_especialidad.php" class="btn btn-success">
