...
if (isset($_GET['eliminar'])) {
  ...
  $check = $conn->prepare("SELECT COUNT(*) AS total FROM cita WHERE id_consultorio = ? AND estado IN ('Pendiente', 'Confirmada')");
  ...
  if ($total > 0) {
    header("Location: /admin/consultorios/lista_consultorios.php?msg_error=No+se+puede+eliminar:+el+consultorio+tiene+{$total}+cita(s)+activa(s).");
    exit;
  }
  ...
  header("Location: /admin/consultorios/lista_consultorios.php?msg=Consultorio+eliminado+correctamente.");
  exit;
}
...
<div class="card mx-auto" style="max-width: 900px;">
  <div style="padding: 30px;">
            ...
            <tr>
              ...
              <td style="text-align:center;">
                <a class="btn btn-sm btn-danger"
                  href="/admin/consultorios/lista_consultorios.php?eliminar=<?= $row['id_consultorio'] ?>"
                  title="Eliminar"
    ...
    <div class="d-flex justify-content-end mt-4">
      <a href="/admin/consultorios/registrar_consultorio.php" class="btn btn-success">
